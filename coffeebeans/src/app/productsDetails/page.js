...
import product1 from "../../../public/assets/PocketBrew.png"
import product2 from "../../../public/assets/FW1.png"
          ...
          <div className="absolute bottom-0 right-0 w-[2px] h-0 bg-[#ad6d2f] transition-all duration-500 group-hover:h-10"></div>
                    ...
                    <div>
                        ...
                        <p className="product-sub-paragraph opacity-90 p-2">
                            <span className='product-sub-heaindg font-semibold'> Description:</span>  Pocket Brew brings convenience without compromise. Perfect for the explorer,
