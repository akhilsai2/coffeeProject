...
import coffeplant from "../../../public/coffeeplant.jpg"
import coffeebeans from "../../../public/coffeebeans.jpg"
import coffeegradingmachine from "../../../public/coffeegradingmachine.jpg"
import coffeebeansprocess from "../../../public/coffeebeansprocess.jpg"
            ...
            <div className="overflow-auto h-screen bg-cover bg-fixed bg-center" >
                ...
                <div className="flex flex-col md:flex-row items-center justify-between m-3 space-y-5 md:space-y-0 overflow-auto  p-4 rounded-xl  transition">
                    ...
                    <img
                        ...
                        alt="Coffee Plant"
                        className="w-180 h-40 object-cover md:h-70 transition-transform duration-500 hover:scale-105 rounded-tl-[20px] rounded-tr-[10px] rounded-br-[30px] rounded-bl-[5px] m-3"
                    />
                ...
                <div className="flex flex-col md:flex-row items-center justify-between m-3 space-y-5 md:space-y-0 overflow-auto  p-4 rounded-xl  transition">
                    {/* Image with Border Radius and Hover Animation */}
                    <img
                        src="https://images.unsplash.com/photo-1524350876685-274059332603?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NjR8fGNvZmZlZSUyMHBsYW50fGVufDB8fDB8fHww"
                        alt="Coffee Plant"
                        className="w-180 h-40 object-cover md:h-70 transition-transform duration-500 hover:scale-105 rounded-tl-[20px] rounded-tr-[10px] rounded-br-[30px] rounded-bl-[5px] m-3"
                    />
                    {/* Text with Font Size and Centering */}
