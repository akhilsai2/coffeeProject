  ...
  return (
    <div className="overflow-auto h-screen bg-cover bg-fixed bg-center">
      <div className="product-details-card overflow-auto top-0  left-0 w-full z-50 bg-white flex flex-col items-center shadow-md">
        <h1 className="text-4xl font-bold text-white mt-[10%] uppercase">
          Products Info
        </h1>
      ...
      <div className="flex flex-col md:flex-row items-center justify-between m-3 space-y-5 md:space-y-0 overflow-auto  p-4 rounded-xl  transition">
        ...
        <div className="relative group w-full text-black flex flex-col items-center justify-center font-bold text-center md:text-left space-y-4 md:space-y-2 p-3 m-2 overflow-hidden">
          ...
          <div>
            <h1 className="product-sub-heaindg pl-2">
              Roast Level:
              <span className="product-sub-paragraph pl-2">
            ...
            <p className="product-sub-paragraph opacity-90 p-2">
              <span className="product-sub-heaindg"> Description:</span> Pocket
              Brew brings convenience without compromise. Perfect for the
        ...
        <div className="relative group w-full text-black flex flex-col items-center justify-center font-bold text-center md:text-left space-y-4 md:space-y-2 p-3 m-2 overflow-hidden">
          ...
          <div>
            ...
            <h1 className="product-sub-heaindg pl-2">
              {" "}
              Altitude:
              <span className="product-sub-paragraph pl-2"> ~1000 meters</span>
            </h1>
            <p className="product-sub-paragraph opacity-90 p-2">
              <span className="product-sub-heaindg"> Description:</span> Let the
              ...
              nature’s depth. Each sip o ers a harmonious blend of aromatic
        ...
        <div className="relative group w-full text-black flex flex-col items-center justify-center font-bold text-center md:text-left space-y-4 md:space-y-2 p-3 m-2 overflow-hidden">
          ...
          <div>
            ...
            <h1 className="product-sub-heaindg pl-2">
              {" "}
              Altitude:
              <span className="product-sub-paragraph pl-2">1200+ meters</span>
            </h1>
            <p className="product-sub-paragraph opacity-90 p-2">
              <span className="product-sub-heaindg"> Description:</span>A true
